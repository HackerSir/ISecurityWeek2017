...
var now_question=0;
var question_lab=[
["下列哪項處理垃圾郵件的方法？","執行附加檔案，查看內容","回覆並要求寄件者停止","直接刪除","轉寄給朋友看","直接刪除"],
["為了避免收到垃圾郵件，平時該怎麼做？","定時更新修補程式","定時更新病毒碼","安裝防火牆","不隨意在網路上留下電子郵件","不隨意在網路上留下電子郵件"],
["如果用來上網的電腦沒有安裝防火牆，可能產生什麼風險？","電腦檔案被破壞","個人資料被竊取","電腦被駭客操控","其餘三者皆是","其餘三者皆是"],
["有些作業系統常常幫我們自動更新，請問：為什麼需要進行更新？","提升遊戲執行速度","清除電腦病毒","修補漏洞，降低被駭風險","其餘三者皆是","修補漏洞，降低被駭風險"],
["在使用公用 Wi-Fi時，下列何者網路行為是安全的？","收發電子郵件","登入網路銀行進行轉帳","查詢資料，不登入任何帳號密碼","其餘三者皆是","查詢資料，不登入任何帳號密碼"]
["為了避免資料遺失，下列何者備份方法是錯的？","將資料複製到外接硬碟","將資料複製到同一顆硬碟","將資料燒進光碟","將資料上傳至檔案伺服器","將資料複製到同一顆硬碟"],
["當瀏覽器的網址列出現 https時，代表網站具有何者功能？","資料是加密傳輸的","具有網路信賴付款機制","不會有網路交易糾紛","只要出現這個就絕對安全","資料是加密傳輸的"],
["在購物平台上，為何需要注意網站有無安全認證(https)？","確保賣家有支付運費","代表商品比較便宜","保護電腦不會中毒","確保個資傳輸時有加密保護","確保個資傳輸時有加密保護"],
["電腦使用到一半要離開座位時，怎麼做比較安全？","請附近的人幫我顧","貼上「暫離、請勿觸碰」的標籤","關閉螢幕電源","將電腦鎖定，設定保護密碼","將電腦鎖定，設定保護密碼"],
["開啟不常見的網站時，跳出提醒顯示你中獎該怎麼做？","中獎開心領取","不理他，一定是釣魚網站","馬上填個資","轉傳網頁給朋友一起抽","不理他，一定是釣魚網站"],
["如果中了勒索病毒怎麼半？","立即關機，防止加密更多檔案","繼續使用電腦，查詢解決方法","不理會","把檔案copy出來在關機","立即關機，防止加密更多檔案"],
["在網站上填資料時要注意什麼？","確認網址正確","確認傳輸是否加密(https)","是否在個人電腦上使用","其餘三者皆是","其餘三者皆是"],
["下列密碼型式比較安全","使用自己生日","使用大小寫與數字，每個網站密碼不同","每個網站使用同組密碼","使用喜歡的人的生日","使用大小寫與數字，每個網站密碼不同"],
];
var maxques = 13; //題數
