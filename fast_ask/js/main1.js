...
var question_lab=[
	...
	["開啟夾帶病毒的垃圾郵件，可能會造成哪一種危害？","電腦中毒","執行不明的程式","遭安裝木馬程式","以上皆是","以上皆是","19"],
	["在學校或網咖等地方使用公共電腦，應該注意哪一種可能的風險？","若有存取檔案，可能感染病毒","若有輸入密碼，可能被側錄","若有輸入個人資料，可能遭外洩或盜用","以上皆是","以上皆是","20"],
	["接到疑似是詐騙電話時，應該如何處理？","撥打165反詐騙專線求證","檢查是否有來電號碼顯示","回撥對方提供的電話號碼求證","只要不是要求操作ATM，就不用處理","撥打165反詐騙專線求證","21"],
	["發生網路交易糾紛時，可以向哪個單位或透過哪種方式尋求協助？","各縣市政府的消費者保護官員","到行政院消保會網站，查詢相關資訊","撥打全國性消費者服務專線1950","以上皆是","以上皆是","22"],
	["電腦病毒通常附著在 ","開機磁碟內","其他程式中","WORD檔案中","以上皆是","以上皆是","23"],
	["下列何者為作業系統?","Microsoft Windows NT","Microsoft Surface","Microsoft Visual","Microsoft Office","Microsoft Windows NT","24"],
