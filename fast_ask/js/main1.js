...
var question_lab=[
	...
	["用來上網的電腦沒有安裝防火牆，可能產生什麼風險？","電腦檔案被破壞","個人資料被竊取","電腦被駭客操控","其餘三者皆是","其餘三者皆是","3"],
	["有些作業系統常常幫我們自動更新，請問：為什麼需要進行更新？","提升遊戲執行速度","清除電腦病毒","修補漏洞，降低被駭風險","其餘三者皆是","修補漏洞，降低被駭風險","4"],
	["在使用公用WiFi時，下列何者網路行為是安全的？","收發電子郵件","登入網路銀行進行轉帳","查詢資料，不登入任何帳號密碼","其餘三者皆是","查詢資料，不登入任何帳號密碼","5"],
	["為了避免資料遺失，下列何者備份方法是<b>錯</b>的？","將資料複製到外接硬碟","將資料複製到同一顆硬碟","將資料燒進光碟","將資料上傳至檔案伺服器","將資料複製到同一顆硬碟","6"],
	["當瀏覽器的網址列出現https時，代表網站具有何者功能？","資料是加密傳輸的","具有網路信賴付款機制","不會有網路交易糾紛","只要出現這個就絕對安全","資料是加密傳輸的","7"],
	...
	["在學校或網咖等地方使用公共電腦，應該注意哪一種可能的風險？","若有存取檔案，可能感染病毒","若有輸入密碼，可能被側錄","若有輸入個人資料，可能遭外洩或盜用","其餘三者皆是","其餘三者皆是","20"],
	["接到疑似詐騙電話時，應該如何處理？","撥打165反詐騙專線求證","檢查是否有來電號碼顯示","回撥對方提供的電話號碼求證","只要不是要求操作ATM，就不用處理","撥打165反詐騙專線求證","21"],
	["下面哪一項<b>不是</b>預防感染勒索病毒的方法？","定期更新軟體","備份重要文件","只打開信任的郵件","安裝防護軟體","備份重要文件","22"],
	["電腦病毒通常附著在？","開機磁碟內","其他程式中","WORD檔案中","其餘三者皆是","其餘三者皆是","23"],
	["何者為作業系統？","Microsoft Windows NT","Microsoft Surface","Microsoft Visual","Microsoft Office","Microsoft Windows NT","24"],
	["何謂滲透測試？","模擬駭客手法攻擊","敲敲電腦試試硬度","拿水倒電腦試試防水性","觀看電腦內部資料","模擬駭客手法攻擊","25"],
	["何謂弱掃工具？","ZAP","TimeTree","7-Zip","Packet Tracer","ZAP","26"],
	["下列何者不是電腦中毒後所發生之現象？","檔案長度無故變長","無法開機","電源突然中斷","鍵盤無法輸入資料","電源突然中斷","27"],
	["哪一項<b>不是</b>勒索病毒主要的感染途徑？","網路廣告","被駭客入侵的網站","隨身碟","惡意郵件","隨身碟","28"],
	["勒索病毒危害很大, 是因為？","沒有人可以躲過它的危害","它是最新科技與最新技術組成的軟體","很多人沒有裝防護軟體","它會將硬碟整個格式化","很多人沒有裝防護軟體","29"],
	["哪一個是勒索病毒曾經使用過的手法？","網路釣魚信件","針對瀏覽器或作業系統上的漏洞","內含惡意程式的網路廣告或論壇文章","其餘三者皆是","其餘三者皆是","30"],
